...
/* harmony import */ var _components_Navbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1696);
...
const MainLayout = ({ children , logoClassText  })=>{
    const navbarRef = react__WEBPACK_IMPORTED_MODULE_2___default().useRef(null);
    const logoRef = react__WEBPACK_IMPORTED_MODULE_2___default().useRef(null);
